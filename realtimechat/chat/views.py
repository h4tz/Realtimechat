...
def room(request, room_name):
    ...
    return render(request, 'chat/room.html', {'room_name': room_name, 'messages': messages, 'user': user})
...
def private_chat(request, username):
    ...
    messages = PrivateMessage.objects.filter(user1__in=[user1, user2], user2__in=[user1, user2])
